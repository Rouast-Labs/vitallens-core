...
pub fn get_vital_meta(vital_id: &str) -> Option<VitalMeta> {   
    match vital_id {
        ...
        "pwa" => Some(VitalMeta {
            ...
            processing: None,
            unit: "unitless".to_string(),
            display_name: "Pulse Wave Arrival".to_string(),
        ...
        "pwp" => Some(VitalMeta {
            ...
            processing: None,
            unit: "unitless".to_string(),
            display_name: "Pulse Wave Peak".to_string(),
        ...
        "ptt" => Some(VitalMeta {
            ...
            processing: None,
            unit: "ms".to_string(),
            display_name: "Pulse Transit Time".to_string(),
            short_name: "PTT".to_string(),
            color: "#E62100".to_string(),
            emoji: "❤️".to_string(),
        }),
        ...
        "pwv" => Some(VitalMeta {
            ...
            display_name: "Pulse Wave Velocity".to_string(),
